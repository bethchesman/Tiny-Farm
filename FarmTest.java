...
public class FarmTest {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		/*
		 *You need to delete stat.dat because it existing on your computer still, the program will 
		 *come up with an error tryong to create another file of the same name
		 */
	}
}
